...
func (bc *Blockchain) MarshaJSON() ([]byte, error) {
	return json.Marshal(struct {
...
func (t *TransactionRequest) Validate() bool {
	if t.SenderPublicKey == nil || t.SenderBlockchainAddress == nil || t.RecipientBlockchainAddress == nil || t.Value == nil || t.Signature == nil {
		return false
	}
